...
public class SingleMessageService
{
    ...
    private async Task<bool> EnsureSchemaInitializedAsync(HaloCommunityBotContext db)
    {
    ...
    private static async Task<bool> TableExistsAsync(HaloCommunityBotContext db, string tableName)
    {
    ...
    private static async Task<bool> TableColumnExistsAsync(HaloCommunityBotContext db, string tableName, string columnName)
    {
        var connection = db.Database.GetDbConnection();
        var closeWhenDone = connection.State != System.Data.ConnectionState.Open;
    ...
    private static async Task EnsureColumnExistsAsync(HaloCommunityBotContext db, string tableName, string columnName, string sqlTypeDefinition)
    {
    ...
    private static async Task CreateMissingSingleMessageSchemaAsync(HaloCommunityBotContext db)
    {
