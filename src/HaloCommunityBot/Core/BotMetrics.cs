...
/// <summary>
/// Prometheus metric definitions for HaloCommunityBot.
/// All metrics include a static <c>service="halo-bot"</c> label so they can be
...
internal static class BotMetrics
{
    ...
    private static readonly string[] ServiceLabelValues = ["halo-bot"];
