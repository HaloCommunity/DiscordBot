...
HALOCOMMUNITYBOT_AllCapsModeration__Enabled=true
HALOCOMMUNITYBOT_AllCapsModeration__DeleteMessage=true
HALOCOMMUNITYBOT_AllCapsModeration__MinLetters=8
HALOCOMMUNITYBOT_AllCapsModeration__MinUppercaseRatio=0.7
HALOCOMMUNITYBOT_AllCapsModeration__WarningDurationSeconds=10
```
...
| `ALL_CAPS_MODERATION_ENABLED` | `HALOCOMMUNITYBOT_AllCapsModeration__Enabled` |
| `ALL_CAPS_MODERATION_DELETE_MESSAGE` | `HALOCOMMUNITYBOT_AllCapsModeration__DeleteMessage` |
| `ALL_CAPS_MODERATION_MIN_LETTERS` | `HALOCOMMUNITYBOT_AllCapsModeration__MinLetters` |
| `ALL_CAPS_MODERATION_MIN_UPPERCASE_RATIO` | `HALOCOMMUNITYBOT_AllCapsModeration__MinUppercaseRatio` |
| `ALL_CAPS_MODERATION_WARNING_DURATION_SECONDS` | `HALOCOMMUNITYBOT_AllCapsModeration__WarningDurationSeconds` |
